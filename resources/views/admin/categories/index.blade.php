<x-app-layout>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100">Categories</h2>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($categories as $category)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-6 py-4 text-gray-800 dark:text-gray-100">{{ $category->name }}</td>
                            <td class="px-6 py-4 text-center space-x-2">
                                ...
                                <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button class="px-3 py-1 rounded-md bg-red-600 hover:bg-red-700 text-white text-sm font-medium transition"
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-4 text-gray-500 dark:text-gray-300">No categories found</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
